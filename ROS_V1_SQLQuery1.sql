...
(
	[SocialEventId]		int PRIMARY KEY FOREIGN KEY REFERENCES SocialEvents(SocialEventId),
	[SocialEventType]	varchar(50) NOT NULL
);

CREATE TABLE [RaceEvents]
(
	[RaceEventId]		int PRIMARY KEY FOREIGN KEY REFERENCES SocialEvents(SocialEventId) NOT NULL,
